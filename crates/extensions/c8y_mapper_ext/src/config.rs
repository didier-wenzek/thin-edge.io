...
use tedge_api::mqtt_topics::ChannelFilter::MeasurementMetadata;
...
impl C8yMapperConfig {
    ...
    pub fn from_tedge_config(
        ...
        // Add measurement metadata topic
        topics.add_all(mqtt_schema.topics(AnyEntity, MeasurementMetadata));
