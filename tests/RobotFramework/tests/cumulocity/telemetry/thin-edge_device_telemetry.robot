...
Thin-edge devices sending metadata object along measurements
    Execute Command
    ...    tedge mqtt pub 'te/device/main///m/g1' '{"robot_mech_energy":{"accumulated_energy": 0.1},"measurement_context":{"status": "nominal","cycle_id": "cycle-98765"}}'
    ${measurements}=    Device Should Have Measurements
    ...    minimum=1
    ...    maximum=1
    ...    type=g1
...
Thin-edge devices sending metadata strings along measurements
    Execute Command
    ...    tedge mqtt pub 'te/device/main///m/g2' '{"robot_mech_energy": 0.1,"prop1":"foo","prop2":"bar"}'
    ${measurements}=    Device Should Have Measurements
    ...    minimum=1
    ...    maximum=1
    ...    type=g2
...
Thin-edge devices sending arbitrary metadata values along measurements
    Execute Command
    ...    tedge mqtt pub 'te/device/main///m/g3' '{"robot_mech_energy": 0.1,"prop1":"foo","prop2":false,"prop3":["foo", "bar"]}'
    ${measurements}=    Device Should Have Measurements
    ...    minimum=1
    ...    maximum=1
    ...    type=g3
...
Thin-edge devices rejecting measurements mixed with metadata
    Execute Command
    ...    tedge mqtt pub 'te/device/main///m/g4' '{"robot_mech_energy": 0.1,"props":{"version": 1.2,"machine_type": "value",}}'
    ${measurements}=    Device Should Have Measurements
    ...    minimum=0
    ...    maximum=0
    ...    type=g4
